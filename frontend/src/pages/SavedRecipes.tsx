...
// import { Sparkles, Clock, ChefHat, Users, Utensils, ArrowLeft, Trash2 } from 'lucide-react';
// import { toast } from 'sonner';
// import { api } from '../utils/api';
// import { useNavigate } from 'react-router-dom';
// import type { Recipe, SavedRecipe, RecipeIngredient } from '../types/api';
...
//                             <Card
//                                 key={recipe.id}
//                                 className="shadow-hover border-0 bg-gradient-to-br from-background to-muted/10 transition-all duration-300 hover:shadow-lg"
//                             >
//                                 <CardHeader className="border-b bg-gradient-card rounded-t-lg">
//                                     <div className="flex items-start justify-between">
//                                         <div className="flex-1">
//                                             <CardTitle className="text-2xl font-bold mb-3 bg-gradient-hero bg-clip-text text-transparent">
