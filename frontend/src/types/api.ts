...
export interface SavedTransformationResponse {
  id: number;
  title: string;
  description: string;
  transformation_idea: string;
...
export interface TasteProfileBase {
  likes: string[];
  dislikes: string[];
  dietary_preferences: string[];
  allergies: string[];
...
export interface TasteProfileCreate extends TasteProfileBase {}
...
export interface TasteProfileResponse extends TasteProfileBase {
  id: number;
  user_id: number;
  updated_at: string;
}
